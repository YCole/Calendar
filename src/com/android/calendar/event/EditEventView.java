    ...
    public EditEventView(Activity activity, View view, EditDoneRunnable done,
       ...
       /* mLocationAdapter = new EventLocationAdapter(activity);
        ...
        mAttendeesList.setTag(mAttendeesList.getBackground());
         ...
         //T
        /*zhouqiang HP50B61 BUG 113883 116020 116014  add start*/
        mDescriptionTextView.setFilters(new InputFilter[]{new InputFilter.LengthFilter(1000)});
        mLocationTextView.setFilters(new InputFilter[]{new InputFilter.LengthFilter(100)});
        mTitleTextView.setFilters(new InputFilter[]{new InputFilter.LengthFilter(30)});
        mTitleTextView.addTextChangedListener(
                new MaxLengthToastTextWatcher(30, mActivity));
         mLocationTextView.addTextChangedListener(
                new MaxLengthToastTextWatcher(100, mActivity));
         mDescriptionTextView.addTextChangedListener(
                 new MaxLengthToastTextWatcher(1000, mActivity));
         /*zhouqiang HP50B61 BUG 113883 116020 116014 add end*/
    ...
    private class MaxLengthToastTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            if (editable.length() >= mMaxLength) {
                Toast.makeText(mContext, R.string.max_chars_toast_message1, Toast.LENGTH_SHORT)
                     .show();
            }
        }
    }
