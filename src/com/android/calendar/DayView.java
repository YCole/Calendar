...
//        mContext.startProgressSpinner();
    ...
    private void drawAmPm(Canvas canvas, Paint p) {
        ...
        p.setTypeface(mBold);
        p.setAntiAlias(true);
        /* gengwenda modify for bug114243 RIGHT->LEFT 20160513 start*/
        p.setTextAlign(Paint.Align.LEFT);
        /* gengwenda modify for bug114243 RIGHT->LEFT 20160513 end*/
        String text = mAmString;
        if (mFirstHour >= 12) {
            text = mPmString;
        }
        int y = mFirstCell + mFirstHourOffset + 2 * mHoursTextHeight + HOUR_GAP;
        /* gengwenda modify for bug114243 LEFT->RIGHT 20160513 start*/
        canvas.drawText(text, HOURS_RIGHT_MARGIN, y, p);
        /* gengwenda modify for bug114243 LEFT->RIGHT 20160513 end*/
    ...
    private void drawDayHeader(String dayStr, int day, int cell, Canvas canvas, Paint p) {
        ...
        if (mNumDays > 1) {
            ...
            if (LunarUtils.showLunar(mContext)) {
                /* gengwenda modify for bug114243 y+4 20160516 start*/
                y = DAY_HEADER_HEIGHT + 4 - DAY_HEADER_BOTTOM_MARGIN - DATE_HEADER_FONT_SIZE - 2;
            } else {
                y = DAY_HEADER_HEIGHT + 4 - DAY_HEADER_BOTTOM_MARGIN;
                /* gengwenda modify for bug114243 y+4 20160516 end*/
            }
            // Draw day of the month
